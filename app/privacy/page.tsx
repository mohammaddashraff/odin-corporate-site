    ...
    <section className="section-spacing">
      <Container className="max-w-4xl">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-muted md:text-base">
          <p>
            ODIN collects contact details and project inquiry information to
            respond to requests, prepare proposals, and improve service
            delivery.
          </p>
          <p>
            We process submitted data for communication, qualification, and
            operational planning. Data is retained only as long as required for
            legitimate business and legal purposes.
          </p>
          <p>
            ODIN applies reasonable technical and organizational safeguards to
            protect information against unauthorized access, disclosure, or
            misuse.
          </p>
          <p>
